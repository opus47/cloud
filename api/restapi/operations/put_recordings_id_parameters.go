...
type PutRecordingsIDParams struct {
	...
	*/
	...
	/*The recording to add or update
	  Required: true
	  In: body
	*/
...
func (o *PutRecordingsIDParams) bindAuthorization(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
