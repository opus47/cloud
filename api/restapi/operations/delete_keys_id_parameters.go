...
// DeleteKeysIDParams contains all the bound params for the delete keys ID operation
// typically these are obtained from a http.Request
//
// swagger:parameters DeleteKeysID
...
func (o *DeleteKeysIDParams) bindAuthorization(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *DeleteKeysIDParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
